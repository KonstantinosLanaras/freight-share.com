 ...
 * Doesn't attempt to special-case Monaco/San Marino/Andorra's partial
 * customs arrangements with the EU; treated as outside the union, which
 * is the conservative (over-warn, not under-warn) direction.
 */
