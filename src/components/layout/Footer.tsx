...
import { Truck, Package, Mail, MapPin, Phone } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-secondary-foreground/70">
              <li><Link to="/how-it-works" className="hover:text-secondary-foreground transition-colors">{t('nav.howItWorks')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-secondary-foreground/70">
              ...
              <li><Link to="/research" className="hover:text-secondary-foreground transition-colors">Research</Link></li>
            </ul>
          </div>
