        ...
        <div className="grid lg:grid-cols-3 gap-6">
                      ...
                      <div className="relative">
                        ...
                        {index < shipment.timeline.length - 1 && (
                          <div className={`absolute top-10 left-1/2 w-0.5 h-8 -translate-x-1/2 ${
                            item.completed ? 'bg-success/50' : 'bg-border'
                          }`} />
                        )}
                      </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-shipper/10 flex items-center justify-center">
                    <User className="h-6 w-6 text-shipper" />
                  </div>
                  <div>
              ...
              <CardContent>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-carrier/10 flex items-center justify-center">
                    <User className="h-6 w-6 text-carrier" />
                  </div>
                  <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="carrier" className="w-full">
                  <CheckCircle className="h-4 w-4" />
                  Mark as Delivered
                </Button>
            ...
            <Card className="bg-success/5 border-success/20">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-success">Payment Secured</div>
